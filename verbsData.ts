...
export const GAME_SCENARIOS: GameScenario[] = [
  {
    ...
    imageAlt: "Pedro waking up in the morning",
    options: [
      {
        text: "Yo me levanto",
        isCorrect: true,
  ...
  },
  {
    id: 2,
    stage: "morning",
    situation: "8:00 AM - Higiene de Pedro",
    situationArm: "8:00 Առավոտ - Պեդրոյի լոգանքը։",
    dialoguePedrito: "Para empezar el día con energía, 'ես լողանում եմ' con agua fría.",
    dialoguePedritoArm: "Օրն էներգիայով սկսելու համար՝ «ես լողանում եմ» սառը ջրով։",
    imageAlt: "Pedro in the shower",
    options: [
      {
        text: "me ducho",
        isCorrect: true,
        explanationArm: "Ճի՛շտ է: 'Ducharse'-ն անդրադարձ բայ է, որովհետև ինքներս մեզ ենք լվանում։"
      },
      {
        text: "ducho",
        isCorrect: false,
        explanationArm: "Սխալ է: Առանց 'me'-ի 'ducho' նշանակում է ուրիշին (օրինակ՝ շանը) լողացնել։"
      }
    ]
  },
  {
    ...
    imageAlt: "Pedro chatting with friends on mobile",
    options: [
      {
        text: "quedamos",
        isCorrect: true,
        explanationArm: "Բրավո՛: 'Quedar' նշանակում է պայմանավորվել հանդիպել։ Սա իսպանացիների սիրելի բառն է։"
      },
      {
        text: "nos quedamos",
        isCorrect: false,
        explanationArm: "Ո՛չ, 'nos quedamos' նշանակում է «մենք մնում ենք» որևէ վայրում (օրինակ՝ տանը)։"
      }
    ]
  },
  {
    id: 4,
    stage: "afternoon",
    situation: "16:00 PM - Hace frío y llueve",
    situationArm: "16:00 Կեսօր - Ցուրտ է և անձրև է գալիս։",
    dialoguePedrito: "No quiero salir con esta lluvia. 'Ես տանն եմ մնում' a leer un libro.",
    dialoguePedritoArm: "Այս անձրևին չեմ ուզում դուրս գալ։ «Ես մնում եմ տանը»՝ գիրք կարդալու։",
    imageAlt: "Pedro looking at rain outside the window",
    options: [
      {
        text: "Me quedo en casa",
        isCorrect: true,
        explanationArm: "Ճի՛շտ է: 'Quedarse' անդրադարձ բայն օգտագործվում է որևէ վայրում ֆիզիկապես մնալու համար։"
      },
      {
        text: "Quedo en casa",
        isCorrect: false,
        explanationArm: "Սխալ է: Առանց 'me'-ի 'quedo en casa' նշանակում է «տանն եմ պայմանավորվում հանդիպել»։"
      }
    ]
  },
  {
    ...
    dialoguePedrito: "Estaba viendo una película, pero tenía tanto sueño que de repente 'ես քնով անցա'...",
    dialoguePedritoArm: "Ֆիլմ էի դիտում, բայց այնքան քնկոտ էի, որ հանկարծ «ես քնով անցա» (աչքս կպավ)։",
    imageAlt: "Pedro falling asleep on the couch",
    options: [
      {
        text: "me dormí",
        isCorrect: true,
        explanationArm: "Հրաշալի՛ է: 'Dormirse' նշանակում է քնով անցնել (անցում քնի վիճակին)։"
      },
      {
        text: "dormí",
        isCorrect: false,
        explanationArm: "Ո՛չ, 'dormí'-ն պարզապես նշանակում է «ես քնեցի (որոշակի ժամանակ)», այլ ոչ թե քնով անցար։"
      }
    ]
  },
  {
    ...
    imageAlt: "Pedro going to bed in pajamas",
    options: [
      {
        text: "me acuesto",
        isCorrect: true,
      ...
      },
      {
        text: "acuesto",
        isCorrect: false,
        explanationArm: "Սխալ է: 'Acuesto' առանց դերանվան նշանակում է պառկեցնել ուրիշին (օրինակ՝ եղբորը)։"
      }
    ]
  }
];
