...
const SANDBOX_SENTENCES_MAP: Record<string, Record<string, SandboxSentence>> = {
  ...
  "levantar-levantarse": {
    ...
    él: {
      nonReflexive: { spanish: "Pedro levanta su mochila de senderismo.", armenian: "Պեդրոն բարձրացնում է իր արշավային պայուսակը։" },
  ...
  "dormir-dormirse": {
    ...
    él: {
      nonReflexive: { spanish: "Pedro duerme muy tranquilo en el sillón rojo.", armenian: "Պեդրոն շատ հանգիստ քնում է կարմիր բազկաթոռին։" },
  ...
  "acostar-acostarse": {
    ...
    él: {
      nonReflexive: { spanish: "Pedro acuesta al osito de peluche en la cama.", armenian: "Պեդրոն խաղալիք արջուկին պառկեցնում է մահճակալին։" },
